...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "SpecFlowMenuTests", "\tIn order to easily find needed documentation\r\n\tAs a specflow user\r\n\tI want to be" +
        ...
        [NUnit.Framework.TestCaseAttribute("Docs", "Getting Started", "Getting Started", null)]
        public virtual void ClickingMenuOptionFromTheMainMenuShouldOpenCorrespondingPage(string menuItem, string subMenuItem, string title, string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Clicking menu option from the main menu should open corresponding page", null, tagsOfScenario, argumentsOfScenario);
#line 7
